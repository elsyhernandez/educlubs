...
<body>
  ...
  <h1 class="titulo">Bien Venidos  al Club de Danza y Baile</h1>

  <div class="pregunta">¿Qué es danza?</div>
  <div class="espera">...</div>

  <div class="respuesta">
    Es una forma de expresión artística y movimiento físico utilizada para manifestar emociones, cultura y unidad social.
    <div class="cuadro estetico">Estético</div>
    <div class="cuadro artistico">Artístico</div>
    <div class="cuadro cultural">Cultural</div>
    <div class="cuadro expresivo">Expresivo</div>
  </div>
...
<div class="info-club">
  ...
  <div class="info-box">
    ...
    <div class="texto">
      ...
      <p>Normalmente los ensayos simpre son los Jueves y viernes de 2:00pm a 5:00pm y los sabados de 9:30am a 12:00pm</p>
    </div>
  </div>
  ...
  <div class="info-box invertido">
    ...
    <div class="texto">
      <h3>Materiales</h3>
      <p>Al principio no se te pedira nada solo tu presencia, diciplina y ganas de querer aprendrer,
        si te gusta y muestras una buen desarrollo, podras participar en concursos estatales en cual e te pedira dinero para los vestuarios
        y zapatos que abarca desde unos $2000 a $3000 lo demas lo cubrira la escuela. Nos encontramos en la explanada.
      </p>
    </div>
  </div>
  ...
  <div class="registro-container">
     <a class="btn-registrar" href="../actions/register_club.php?type=cultural&club=Danza y Baile">Registrarme</a>
  </div>
