...
<body>
  ...
  <h1 class="titulo">Bien Venidoos  al Club de Oratoria/Declamación</h1>

  <div class="pregunta">¿Qué es Oratoria/Declamación?</div>
  <div class="espera">...</div>

  <div class="respuesta">
   son dos formas de expresión verbal que comparten el uso del lenguaje hablado, 
   pero tienen propósitos y estilos distintos. Ambas requieren habilidades de comunicación,
    presencia escénica y dominio del lenguaje.
    <div class="cuadro estetico">Contenido</div>
    <div class="cuadro artistico">Intención</div>
    <div class="cuadro cultural">Estilo</div>
    <div class="cuadro expresivo">Improvisación</div>
  </div>
...
<div class="info-club">
  ...
  <div class="info-box">
    ...
    <div class="texto">
      <h3>Horario </h3>
      <p>Normalmente los sabados de 10:00am a 12:00 en el aula 20.</p>
    </div>
  </div>
  ...
  <div class="registro-container">
     <a class="btn-registrar" href="../actions/register_club.php?type=cultural&club=Oratoria/Declamación">Registrarme</a>
  </div>
