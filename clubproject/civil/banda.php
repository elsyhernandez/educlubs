...
<div class="carrusel-container">
    ...
    <div class="carrusel-wrapper" id="carrusel">
        <div class="card" data-index="0">
            <img src="../assets/images/banda1.jpg" alt="Banda de Guerra">
            <div class="info">Ensayo General</div>
        </div>
        <div class="card" data-index="1">
            <img src="../assets/images/banda2.jpg" alt="Banda de Guerra">
            <div class="info">Presentación Cívica</div>
        </div>
        <div class="card" data-index="2">
            <img src="../assets/images/banda3.jpg" alt="Banda de Guerra">
            <div class="info">Competencia Estatal</div>
        </div>
        <div class="card" data-index="3">
            <img src="../assets/images/banda4.jpg" alt="Banda de Guerra">
            <div class="info">Práctica de Marcha</div>
        </div>
        <div class="card" data-index="4">
            <img src="../assets/images/banda5.jpg" alt="Banda de Guerra">
            <div class="info">Taller de Corneta</div>
        </div>
        <div class="card" data-index="5">
            <img src="../assets/images/banda6.jpg" alt="Banda de Guerra">
            <div class="info">Taller de Tambor</div>
        </div>
        <div class="card" data-index="6">
            <img src="../assets/images/banda7.jpg" alt="Banda de Guerra">
            <div class="info">Concurso de Toques</div>
        </div>
        <div class="card" data-index="7">
            <img src="../assets/images/banda8.jpg" alt="Banda de Guerra">
            <div class="info">Desfile Cívico</div>
        </div>
    </div>
