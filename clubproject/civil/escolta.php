...
<div class="pregunta">¿Qué es Escolta?</div>
...
<div class="carrusel-container">
    ...
    <div class="carrusel-wrapper" id="carrusel">
        <div class="card" data-index="0">
            <img src="../assets/images/escolta1.jpg" alt="Escolta">
            <div class="info">Práctica de Marcha</div>
        </div>
        <div class="card" data-index="1">
            <img src="../assets/images/escolta2.jpg" alt="Escolta">
            <div class="info">Ceremonia Cívica</div>
        </div>
        <div class="card" data-index="2">
            <img src="../assets/images/escolta3.jpg" alt="Escolta">
            <div class="info">Concurso Regional</div>
        </div>
        <div class="card" data-index="3">
            <img src="../assets/images/escolta4.jpg" alt="Escolta">
            <div class="info">Ensayo de Rutina</div>
        </div>
        <div class="card" data-index="4">
            <img src="../assets/images/escolta5.jpg" alt="Escolta">
            <div class="info">Revisión de Uniformes</div>
        </div>
        <div class="card" data-index="5">
            <img src="../assets/images/escolta6.jpg" alt="Escolta">
            <div class="info">Taller de Voz de Mando</div>
        </div>
        <div class="card" data-index="6">
            <img src="../assets/images/escolta7.jpg" alt="Escolta">
            <div class="info">Práctica de Flanco</div>
        </div>
        <div class="card" data-index="7">
            <img src="../assets/images/escolta8.jpg" alt="Escolta">
            <div class="info">Competencia Nacional</div>
        </div>
    </div>
