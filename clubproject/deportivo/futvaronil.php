...
<head>
  <meta charset="UTF-8">
  <title>Club de Fútbol varonil</title>
...
<h1 class="titulo">Bienvenidos al Club de Fútbol varonil</h1>

<div class="pregunta">¿Qué es Fútbol varonil?</div>
...
<div class="carrusel-container">
    ...
    <div class="carrusel-wrapper" id="carrusel">
        <div class="card" data-index="0">
            <img src="../assets/images/fut1.jpg" alt="Futbol Varonil 1">
            <div class="info">Entrenamiento</div>
        </div>
        <div class="card" data-index="1">
            <img src="../assets/images/fut2.jpg" alt="Futbol Varonil 2">
            <div class="info">Partido Amistoso</div>
        </div>
        <div class="card" data-index="2">
            <img src="../assets/images/fut3.jpg" alt="Futbol Varonil 3">
            <div class="info">Torneo Interescolar</div>
        </div>
        <div class="card" data-index="3">
            <img src="../assets/images/fut4.jpg" alt="Futbol Varonil 4">
            <div class="info">Tiros Libres</div>
        </div>
        <div class="card" data-index="4">
            <img src="../assets/images/fut5.jpg" alt="Futbol Varonil 5">
            <div class="info">Práctica de Porteros</div>
        </div>
        <div class="card" data-index="5">
            <img src="../assets/images/fut6.jpg" alt="Futbol Varonil 6">
            <div class="info">Festejo de Gol</div>
        </div>
        <div class="card" data-index="6">
            <img src="../assets/images/fut7.jpg" alt="Futbol Varonil 7">
            <div class="info">Estrategia de Equipo</div>
        </div>
        <div class="card" data-index="7">
            <img src="../assets/images/fut8.jpg" alt="Futbol Varonil 8">
            <div class="info">Campeones</div>
        </div>
    </div>
