...
<body>
  <header>
    <h1>Club de Creación Literaria</h1>
    <a href="../../club.php?type=cultural">← Volver a clubes culturales</a>
  </header>
  <div class="club-content">
     <img src="../assets/images/literaria.webp" alt="Imagen Literaria">
    <p><strong>Profesor:</strong> Mtro. Andrés Vázquez</p>
<p><strong>Descripción:</strong> Escribe cuentos, poemas y ensayos. Participa en concursos y publicaciones escolares.</p>
<a class="btn-registrar" href="../../register_club.php?type=cultural&club=Creación literaria">Registrarme</a>
  </div>
</body>
</html>
