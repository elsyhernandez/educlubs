...
<body>
  <header>
    <h1>Club de Arte Manual</h1>
    <a href="../../club.php?type=cultural">← Volver a clubes culturales</a>
  </header>
  <div class="club-content">
 <img src="../assets/images/artemanual.jpg" alt="Imagen Arte Manual">
    <p><strong>Profesor:</strong> Mtro. Rafael Ortega</p>
    <p><strong>Profesor:</strong> Mtra. Claudia Ríos</p>
<p><strong>Descripción:</strong> Aprende técnicas de manualidades, reciclaje creativo y decoración artesanal.</p>
<a class="btn-registrar" href="../../register_club.php?type=cultural&club=Arte manual">Registrarme</a>
  </div>
</body>
</html>
