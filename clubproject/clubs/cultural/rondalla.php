...
<body>
  <header>
    <h1>Club de Música / Rondalla</h1>
    <a href="../../club.php?type=cultural">← Volver a clubes culturales</a>
  </header>
  <div class="club-content">
     <img src="../assets/images/banda7.jpg" alt="Imagen Banda de Guerra">
   <p><strong>Profesor:</strong> Mtro. Luis Ramírez</p>
<p><strong>Descripción:</strong> Aprende guitarra, canto y armonía en grupo. Participa en serenatas, concursos y eventos musicales.</p>
<a class="btn-registrar" href="../../register_club.php?type=cultural&club=Música/Rondalla">Registrarme</a>
  </div>
</body>
</html>
