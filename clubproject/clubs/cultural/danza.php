...
<body>
  <header>
    <h1>Club de Danza y Baile</h1>
    <a href="../../club.php?type=cultural">← Volver a clubes culturales</a>
  </header>
  <div class="club-content">
 <img src="../assets/images/danza2.jpg" alt="Imagen Danza">
    <p><strong>Profesor responsable:</strong> Mtra. Mariana Torres</p>
    <p><strong>Descripción:</strong> Aprende coreografías modernas, folclóricas y urbanas. Participa en presentaciones escolares y eventos culturales.</p>
    <a class="btn-registrar" href="../../register_club.php?type=cultural&club=Danza y baile">Registrarme</a>
  </div>
</body>
</html>
