...
<body>
  <header>
    <h1>Club de Oratoria y Declamación</h1>
    <a href="../../club.php?type=cultural">← Volver a clubes culturales</a>
  </header>
  <div class="club-content">
     <img src="../assets/images/banda1.jpg" alt="Imagen Oratoria y Declamación">
   <p><strong>Profesor:</strong> Mtro. Fernando Ruiz</p>
<p><strong>Descripción:</strong> Mejora tu expresión verbal, seguridad escénica y habilidades de discurso.</p>
<a class="btn-registrar" href="../../register_club.php?type=cultural&club=Oratoria y declamación">Registrarme</a>
  </div>
</body>
</html>
s