...
<body>
  <header>
    <h1>Club de Música Grupo Norteño</h1>
    <a href="../../club.php?type=cultural">← Volver a clubes culturales</a>
  </header>
  <div class="club-content">
     <img src="../assets/images/banda4.jpg" alt="Imagen Banda de Guerra">
    <p><strong>Profesor:</strong> Mtro. Jorge Salinas</p>
<p><strong>Descripción:</strong> Aprende ejecución de instrumentos norteños y ensamble musical. Presentaciones en eventos escolares.</p>
<a class="btn-registrar" href="../../register_club.php?type=cultural&club=Música grupo norteño">Registrarme</a>
  </div>
</body>
</html>
