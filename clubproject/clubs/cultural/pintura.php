...
<body>
  <header>
    <h1>Club de Pintura / Dibujo</h1>
    <a href="../../club.php?type=cultural">← Volver a clubes culturales</a>
  </header>
  <div class="club-content">
     <img src="../assets/images/banda8.jpg" alt="Imagen Pintura y Dibujo">
   <p><strong>Profesor:</strong> Mtra. Gabriela Soto</p>
<p><strong>Descripción:</strong> Explora técnicas de dibujo, acuarela, acrílico y arte libre. Participa en exposiciones escolares.</p>
<a class="btn-registrar" href="../../register_club.php?type=cultural&club=Pintura/Dibujo">Registrarme</a>
  </div>
</body>
</html>
