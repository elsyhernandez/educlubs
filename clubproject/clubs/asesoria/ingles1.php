...
<body>
  <header>
   <h1>Asesoría en Inglés</h1>
    <a href="../../club.php?type=asesoria">← Volver a asesorias</a>
  </header>
  <div class="club-content">
    <img src="../assets/images/futfemenil2.jpg" alt="Imagen Banda de Guerra">
<p><strong>Profesor:</strong> Mtra. Karla Gómez</p>
<p><strong>Descripción:</strong> Mejora tu comprensión, vocabulario y habilidades de conversación en inglés. Enfocado en reforzar lo visto en clase.</p>
<a class="btn-registrar" href="../../register_club.php?type=asesoria&club=Inglés">Registrarme</a>
  </div>
</body>
</html>
