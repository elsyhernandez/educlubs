...
<body>
  <header>
   <h1>Asesoría en Matemáticas 3</h1>
    <a href="../../club.php?type=asesoria">← Volver a asesorias</a>
  </header>
  <div class="club-content">
    <img src="../assets/images/futfemenil4.jpg" alt="Imagen Banda de Guerra">
  <p><strong>Profesor:</strong> Mtro. Juan Pérez</p>
<p><strong>Descripción:</strong> Refuerza tus conocimientos en álgebra y aritmética básica. Ideal para estudiantes de primer semestre.</p>
<a class="btn-registrar" href="../../register_club.php?type=asesoria&club=Matemáticas 4">Registrarme</a>
  </div>
</body>
</html>
