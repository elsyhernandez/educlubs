...
<body>
  <header>
   <h1>Club de Defensa Personal</h1>
  ...
  <div class="club-content">
   ...
   <p><strong>Profesor:</strong> Mtro. Carlos Méndez</p>
<p><strong>Descripción:</strong> Aprende técnicas de defensa, autocontrol y seguridad personal. Fortalece tu confianza y disciplina física.</p>
