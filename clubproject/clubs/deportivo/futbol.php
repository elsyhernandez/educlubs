...
<body>
  <header>
    <h1>Club de Fútbol Femenil</h1>
    <a href="../../club.php?type=deportivo">← Volver a clubes deportivos</a>

  </header>
  <div class="club-content">
    <img src="../assets/images/futfemenil4.jpg" alt="Imagen Banda de Guerra">
   <p><strong>Profesor:</strong> Mtra. Ana Rodríguez</p>
<p><strong>Descripción:</strong> Entrena técnica, trabajo en equipo y participa en ligas escolares. Desarrolla tu rendimiento físico y táctico.</p>
