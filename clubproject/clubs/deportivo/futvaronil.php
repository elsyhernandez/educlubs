...
<body>
  <header>
  <h1>Club de Fútbol Varonil</h1>
   <a href="../../club.php?type=deportivo">← Volver a clubes deportivos</a>

  </header>
  <div class="club-content">
    <img src="../assets/images/fut1.jpg" alt="Imagen Banda de Guerra">
<p><strong>Profesor:</strong> Mtro. Miguel Herrera</p>
<p><strong>Descripción:</strong> Entrena táctica, resistencia y participa en torneos escolares. Mejora tu juego colectivo y liderazgo en cancha.</p>
<a class="btn-registrar" href="../../register_club.php?type=deportivo&club=volifemenil">Registrarme</a>
