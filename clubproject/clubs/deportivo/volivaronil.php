...
<body>
  <header>
    <h1>Club de Voleibol Varonil</h1>
    <a href="../../club.php?type=deportivo">← Volver a clubes deportivos</a>

  </header>
  <div class="club-content">
    <img src="../assets/images/volivaro4.jpg" alt="Imagen Banda de Guerra">
<p><strong>Profesor:</strong> Mtro. Enrique Torres</p>
<p><strong>Descripción:</strong> Entrena fuerza, estrategia y participa en torneos escolares. Mejora tu precisión y trabajo en equipo.</p>
<a class="btn-registrar" href="../../register_club.php?type=deportivo&club=Voleibol varonil">Registrarme</a>
  </div>
</body>
</html>
