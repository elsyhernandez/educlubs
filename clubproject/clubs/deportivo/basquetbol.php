...
<body>
  <header>
    <h1>Club de Basquetbol</h1>
    <a href="../../club.php?type=deportivo">← Volver a clubes deportivos</a>
  </header>
  <div class="club-content">
    <img src="../assets/images/bas1.jpg" alt="Imagen Banda de Guerra">
<p><strong>Profesor:</strong> Mtro. Daniel Gómez</p>
<p><strong>Descripción:</strong> Aprende fundamentos, tácticas y participa en torneos escolares. Mejora tu coordinación, agilidad y trabajo en equipo.</p>
