...
<body>
  <header>
    <h1>Club de Voleibol Femenil</h1>
    <a href="../../club.php?type=deportivo">← Volver a clubes deportivos</a>

  </header>
  <div class="club-content"><img src="../assets/images/volife.jpg" alt="Imagen Banda de Guerra">
  <p><strong>Profesor:</strong> Mtra. Laura Jiménez</p>
<p><strong>Descripción:</strong> Aprende técnica, coordinación y participa en competencias escolares. Fortalece tu agilidad y espíritu deportivo.</p>
