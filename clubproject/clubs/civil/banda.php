...
<head>
  <meta charset="UTF-8">
  <title>Club Banda de Guerra</title>
...
<body>
  <header>
    <h1>Club Banda de Guerra</h1>
    <a href="../../club.php?type=civil">← Volver a clubes civiles</a>
  </header>
  <div class="club-content">
    <img src="../assets/images/banda1.jpg" alt="Imagen Banda de Guerra">
    <p><strong>Profesor:</strong> Mtro. Rafael Ortega</p>
    <p><strong>Descripción:</strong> Aprende ejecución de instrumentos marciales, disciplina y participación en actos cívicos. Representa a la escuela en ceremonias oficiales.</p>
