...
<body>
  ...
  <div class="club-content">
    <img src="../assets/images/escolta1.jpg" alt="Imagen Escolta">
    <p><strong>Profesor:</strong> Mtra. Laura Peña</p>
<p><strong>Descripción:</strong> Formación cívica, coordinación y participación en ceremonias escolares. Desarrolla liderazgo, presencia y respeto por los símbolos patrios.</p>
<a class="btn-registrar" href="../../register_club.php?type=civil&club=Escolta">Registrarme</a>
  </div>
</body>
</html>
