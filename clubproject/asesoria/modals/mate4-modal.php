<!-- Asesoría Mate 4 -->
<div class="modal" id="modal-mate4">
  <div class="modal-content danza">
    <div class="modal-header">
      <h2>Asesoría Matemáticas IV</h2>
      <span class="close-btn" onclick="cerrarModal('mate4')">&times;</span>
    </div>
    <div class="modal-body">
      <div class="modal-left slide-in-left">
        <p><strong>Profesor responsable:</strong> Mtra. Silvia Gómez</p>
        <p><strong>Descripción:</strong> Apoyo en cálculo diferencial e integral, límites y continuidad.</p>
        <a class="btn-inscribirme" href="asesoria/mate4.php">Ver más</a>
      </div>
      <div class="modal-right slide-in-right">
        <img src="  assets/images/bas3.jpg" alt="Mate 4">
      </div>
    </div>
  </div>
</div>
