<!-- Asesoría Mate 2 -->
<div class="modal" id="modal-mate2">
  <div class="modal-content danza">
    <div class="modal-header">
      <h2>Asesoría Matemáticas II</h2>
      <span class="close-btn" onclick="cerrarModal('mate2')">&times;</span>
    </div>
    <div class="modal-body">
      <div class="modal-left slide-in-left">
        <p><strong>Profesor responsable:</strong> Mtra. Laura Martínez</p>
        <p><strong>Descripción:</strong> Apoyo en geometría analítica, funciones y ecuaciones cuadráticas.</p>
        <a class="btn-inscribirme" href="asesoria/mate2.php">Ver más</a>
      </div>
      <div class="modal-right slide-in-right">
        <img src="assets/images/bas2.jpg" alt="Mate 2">
      </div>
    </div>
  </div>
</div>
