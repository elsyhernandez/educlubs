<!-- Asesoría Mate 3 -->
<div class="modal" id="modal-mate3">
  <div class="modal-content danza">
    <div class="modal-header">
      <h2>Asesoría Matemáticas III</h2>
      <span class="close-btn" onclick="cerrarModal('mate3')">&times;</span>
    </div>
    <div class="modal-body">
      <div class="modal-left slide-in-left">
        <p><strong>Profesor responsable:</strong> Mtro. Jorge Ramírez</p>
        <p><strong>Descripción:</strong> Refuerza tus conocimientos en trigonometría, identidades y funciones circulares.</p>
